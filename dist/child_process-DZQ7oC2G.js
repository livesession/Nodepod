...
`;
  ...
  async function installPackages(args, ctx, pm = "npm") {
    const { DependencyInstaller } = await import("./index-DQ74lrOh.js").then(async (m) => {
      await m.__tla;
      return m;
    }).then((n) => n.ag);
...
`;
    ...
    try {
      const { RegistryClient } = await import("./index-DQ74lrOh.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.av);
